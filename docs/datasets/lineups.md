...
WNBA Stats Lineups from wehoop data repository — `leaguedashlineups` (season-level).

| | |
|---|---|
| **Builder** | [`python/wnba_stats_04_lineups_creation.py`](../../python/wnba_stats_04_lineups_creation.py) |
...
_Coverage is tracked per release asset on [`wnba_stats_lineups`](https://github.com/sportsdataverse/sportsdataverse-data/releases/tag/wnba_stats_lineups)._
