...
WNBA Stats Team Boxscores from wehoop data repository — `boxscoretraditionalv3` (game-level).

| | |
|---|---|
| **Builder** | [`python/wnba_stats_14_team_boxscores_creation.py`](../../python/wnba_stats_14_team_boxscores_creation.py) |
| **Release tag** | [`wnba_stats_team_boxscores`](https://github.com/sportsdataverse/sportsdataverse-data/releases/tag/wnba_stats_team_boxscores) |
