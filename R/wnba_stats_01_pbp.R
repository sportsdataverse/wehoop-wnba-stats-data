...
suppressPackageStartupMessages(suppressMessages({
  ...
  library(wehoop,               lib.loc = lib_path)
  library(sportsdataverse,      lib.loc = lib_path)
  library(sportsdataversedata,  lib.loc = lib_path)
}))
