...
Equivalent to::
    ...
    python -m wnba_data_build --datasets lineups --seasons <year>
"""
...
if __name__ == "__main__":
    ...
    # an option, so a stray --datasets on the command line cannot make stage 04
    # build something other than lineups.
