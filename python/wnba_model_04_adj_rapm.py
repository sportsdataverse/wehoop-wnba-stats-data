"""Stage 04 — adj-RAPM engine (RS prior = prev season blend; PO prior = this RS SPM).
...
Usage::
    ...
    python -m wnba_model_04_adj_rapm --seasons 2024 2025 
    scripts/wnba_models.sh 04
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap = argparse.ArgumentParser(prog="python -m wnba_model_04_adj_rapm")
    ...
    n = S.run_adj_rapm(S.parse_seasons(a.seasons), season_types=S.parse_season_types(a.season_types), engines_dir=a.engines_dir)
    print(f"[adj_rapm] wrote {n} artifact group(s)")
    return 0
