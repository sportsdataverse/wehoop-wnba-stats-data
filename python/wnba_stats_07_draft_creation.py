...
Equivalent to::
    ...
    python -m wnba_data_build --datasets draft --seasons <year>
"""
...
if __name__ == "__main__":
    ...
    # an option, so a stray --datasets on the command line cannot make stage 07
    # build something other than draft.
