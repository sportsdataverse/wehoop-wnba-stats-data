...
Equivalent to::
    ...
    python -m wnba_data_build --datasets game_rosters --seasons <year>
"""
...
if __name__ == "__main__":
    ...
    # an option, so a stray --datasets on the command line cannot make stage 11
    # build something other than game_rosters.
