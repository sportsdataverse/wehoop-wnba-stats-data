...
Equivalent to::
    ...
    python -m wnba_data_build --datasets team_boxscores --seasons <year>
"""
...
DATASET = "team_boxscores"

if __name__ == "__main__":
    # DATASET is appended, not prepended: argparse keeps the LAST occurrence of
    # an option, so a stray --datasets on the command line cannot make stage 14
    # build something other than team_boxscores.
