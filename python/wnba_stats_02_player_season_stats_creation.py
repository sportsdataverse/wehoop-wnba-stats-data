...
Equivalent to::
    ...
    python -m wnba_data_build --datasets player_season_stats --seasons <year>
"""
...
if __name__ == "__main__":
    ...
    # an option, so a stray --datasets on the command line cannot make stage 02
    # build something other than player_season_stats.
